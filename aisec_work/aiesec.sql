...
CREATE TABLE `result` (
  ...
  `q11` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `q12` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `q13` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `q14` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `q15` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `q16` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `q17` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `q18` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `q19` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `q20` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
